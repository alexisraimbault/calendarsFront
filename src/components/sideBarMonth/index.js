  ...
  render() {
    ...
    return (
      <div className="sidebar-big-container">
        <div className="sidebar-user-display"></div>
        <div className={sidebarClass}>
          ...
          <div className="sidebar-bottom-menu">
            ...
            >
              ...
              >
                <path
                  d="m13.03 1.87-10.99-1.67c-.51-.08-1.03.06-1.42.39-.39.34-.62.83-.62 1.34v21.07c0 .55.45 1 1 1h3.25v-5.25c0-.97.78-1.75 1.75-1.75h2.5c.97 0 
            ...
            0-.75-.336-.75-.75s.336-.75.75-.75h1.5c.414 0 .75.336.75.75s-.336.75-.75.75z"
                />
                <path
                  d="m22.62 10.842-7.12-1.491v14.649h6.75c.965 0 1.75-.785 1.75-1.75v-9.698c0-.826-.563-1.529-1.38-1.71zm-2.37 
            ...
            <div
              className="sidebar-item-container"
              onClick={towardsOffDaysBoard}
            >
              <div className="label">{"Jours Off"}</div>
              <svg height="20" viewBox="0 0 64 64" width="20">
                <path d="m12 47h4.001v3h-4.001z" />
                <path
                  d="m49 38a11 11 0 1 0 11 11 11.013 11.013 0 0 0 -11-11zm7.192 8.222-8.485 8.485a1 1 0 0 1 -1.414 0l-4.242-4.243a1 1 0 0 1 
            1.414-1.414l3.535 3.536 7.778-7.778a1 1 0 0 1 1.414 1.414z"
                ...
                <path
                  d="m4 22v31a3.009 3.009 0 0 0 3 3h31.063a12.984 12.984 0 1 1 21.937-13.9v-20.1zm14 28a2 2 0 0 1 -2 2h-4a2 2 0 0 1 -2-2v-3a2 2 0 0 1 2-2h4a2 2 0 0 1 2 
            ...
            {isAdmin && (
              <div
                className="sidebar-item-container"
                onClick={openRdvSettingsPopup}
              >
                <div className="label">{"Prise de rdv"}</div>
                <svg viewBox="0 0 512 512" width="20" height="20">
                  <g id="_30-appointment" data-name="30-appointment">
                    <path d="M393.265,129.522a12,12,0,1,0,0-24,28,28,0,1,1,14.405-52h31.7a51.991,51.991,0,1,0-46.107,76Z" />
                    <path d="M272.211,129.522a12,12,0,1,0,0-24,28,28,0,1,1,14.4-52h31.7a51.991,51.991,0,1,0-46.107,76Z" />
                    <path d="M468.927,80.349a12,12,0,0,0-11.662-14.827H382.717a15.979,15.979,0,0,0,10.548,28,24,24,0,1,1,0,48,63.957,63.957,0,0,1-62.856-76H261.664a15.978,15.978,0,0,0,10.547,28,24,24,0,1,1,0,48,63.953,63.953,0,0,1-62.855-76H140.61a15.978,15.978,0,0,0,10.547,28,24,24,0,1,1,0,48,63.953,63.953,0,0,1-62.855-76H81.265A12,12,0,0,0,69.6,74.695L50.978,151.522h400.7Z" />
                    <path d="M151.157,129.522a12,12,0,1,0,0-24,28,28,0,1,1,14.405-52h31.7a51.992,51.992,0,1,0-46.108,76Z" />
                    <path d="M469.265,298.541V129.889l-36.727,151.5A119.558,119.558,0,0,1,469.265,298.541Z" />
                    <path d="M401,277.174a120.287,120.287,0,0,1,19.813,1.645l27.951-115.3H48.069L5.6,338.694a12,12,0,0,0,11.662,14.827H289.221A120.2,120.2,0,0,1,401,277.174Zm-59.735-79.652h32a12,12,0,0,1,0,24h-32a12,12,0,0,1,0-24Zm-232,120h-32a12,12,0,1,1,0-24h32a12,12,0,0,1,0,24Zm8-48h-32a12,12,0,1,1,0-24h32a12,12,0,1,1,0,24Zm16-48h-32a12,12,0,1,1,0-24h32a12,12,0,0,1,0,24Zm56,96h-32a12,12,0,0,1,0-24h32a12,12,0,0,1,0,24Zm8-48h-32a12,12,0,1,1,0-24h32a12,12,0,1,1,0,24Zm16-48h-32a12,12,0,0,1,0-24h32a12,12,0,0,1,0,24Zm56,96h-32a12,12,0,0,1,0-24h32a12,12,0,0,1,0,24Zm8-48h-32a12,12,0,1,1,0-24h32a12,12,0,1,1,0,24Zm16-48h-32a12,12,0,0,1,0-24h32a12,12,0,0,1,0,24Zm32,24h32a12,12,0,1,1,0,24h-32a12,12,0,1,1,0-24Z" />
                    <path d="M69.265,365.521v32a12,12,0,0,0,12,12H281.632a120.352,120.352,0,0,1,3.613-44Z" />
                    <path d="M497.265,65.522H478.036a23.845,23.845,0,0,1,3.229,12V308.049a120.677,120.677,0,0,1,28,37.394V77.522A12,12,0,0,0,497.265,65.522Z" />
                    <path d="M401,289.174a108,108,0,1,0,108,108A108.122,108.122,0,0,0,401,289.174ZM413,480.3V469.174a12,12,0,0,0-24,0V480.3a84.171,84.171,0,0,1-71.129-71.129H329a12,12,0,0,0,0-24H317.871A84.17,84.17,0,0,1,389,314.045v11.129a12,12,0,0,0,24,0V314.045a84.17,84.17,0,0,1,71.129,71.129H473a12,12,0,0,0,0,24h11.129A84.171,84.171,0,0,1,413,480.3Z" />
                    <path d="M424.515,356.688l-25.884,25.884L374.366,370.44a12,12,0,0,0-10.732,21.467l32,16a12,12,0,0,0,13.851-2.248l32-32a12,12,0,0,0-16.97-16.971Z" />
                  </g>
                </svg>
              </div>
            )}
            ...
            <div className="sidebar-item-container" onClick={logout}>
              <div className="label">{"Déconnexion"}</div>
              <svg viewBox="0 0 512 512" width="20" height="20">
                <path
                  d="m320 277.335938c-11.796875 0-21.332031 9.558593-21.332031 21.332031v85.335937c0 11.753906-9.558594
                ...
                />
                <path
                  d="m505.75 198.253906-85.335938-85.332031c-6.097656-6.101563-15.273437-7.9375-23.25-4.632813-7.957031
        ...
        <div className={submenuContainerClass}>
          {menuToggle === 0 && <SettingsMenu />}
          {menuToggle === 1 && <TeamMenu />}
        </div>
