...
class CalendarGridColumnMobile extends Component {
  constructor(props) {
    super(props);
    this.state = {};
  }
  ...
  render() {
    ...
    const columnClass = classNames({
      'mobile-col-container': true,
      'mobile-col-container--today': isToday(day),
    });

    return (
      <div className={columnClass} style={{ left: `0%` }}>
...
export default CalendarGridColumnMobile;
