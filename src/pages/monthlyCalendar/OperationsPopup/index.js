            ...
            <div className="operation-container">
              <div className="operation-top">
                <div className="left-container">
                  ...
                  <div className="edit-operation-btn" onClick={towardsEditOperationPopup(operation.id, operation.name, operation.data, _.get(operation, 'location', ''))}>
              ...
              <div className="link-export">
                <div  onClick={_.partial(this.copyToClipBoard, `input-${operation.id}`)}>{'copier lien export : '}</div><input type="text" value={`calendarexport/${operation.id}`} id={`input-${operation.id}`} />
                </div>

              <div className="link-export">
                <div  onClick={_.partial(this.copyToClipBoard, `rdv-${operation.id}`)}>{'copier lien rdv : '}</div><input type="text" value={`rdv/${operation.id}`} id={`rdv-${operation.id}`} />
                </div>
              </div>
            </div>
          ))}
