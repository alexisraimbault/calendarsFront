...
class DayCalendarDisplay extends Component {
  ...
  openAMOPopup =
    (day, selectedUsers, selectedOperation, hoursKeyObject) => (event) => {
  ...
  render() {
    ...
    const dayClass = classNames({
      ...
      "day-month-master-1-container--weekend":
        !isToday(day) && _.includes([0, 6], moment(day).day()),
      "day-month-master-1-container--off":
        !isToday(day) && !_.includes([0, 6], moment(day).day()) && isOff,
    });
      ...
      <div className={dayClass} onClick={goToDaily(day)}>
        ...
        <Scrollbars autoHeight autoHeightMin={0} autoHeightMax={160}>
          {_.map(eventsByOperations, (eventArray, operationId) => {
            ...
            console.log({ currentOperation, operations, operationId });
