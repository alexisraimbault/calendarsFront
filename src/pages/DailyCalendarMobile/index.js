...
class DailyCalendarMobile extends Component {
  constructor(props) {
    super(props);
  ...
  render() {
    ...
    return (
      !_.isEmpty(fetchDate)
      && (
        <div className="calendar-container-mobile-day">
          {isAdmin && (
...
export default connect(mapStateToProps, mapDispatchToProps)(DailyCalendarMobile);
